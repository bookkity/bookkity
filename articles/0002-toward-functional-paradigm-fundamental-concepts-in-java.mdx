...
## Introduction
We are pretty familiar with OOP, because we use object-oriented programming language, but that doesn't mean we can't draw from other paradigms, and can't combine them.
