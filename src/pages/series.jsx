        ...
        <div className={'flex flex-col w-full'}>
          {series.map(({details, chapters}, index) => (
            <div key={index} className={`w-full pt-6 px-4`}>
              <div className={`flex flex-col lg:flex-row lg:max-h-52 w-full bg-white rounded-lg cursor-pointer hover:scale-[1.02] hover:duration-200`}>
                  <a href={`/series/${details.url}`} className={`w-full lg:w-96 h-52`}>
                      <img
